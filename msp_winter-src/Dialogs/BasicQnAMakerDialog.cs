...
namespace Microsoft.Bot.Sample.QnABot
{
    ...
    public class BasicQnAMakerDialog : QnAMakerDialog
    {
        ...
        public BasicQnAMakerDialog() : base(new QnAMakerService(new QnAMakerAttribute(Utils.GetAppSetting("QnASubscriptionKey"), Utils.GetAppSetting("QnAKnowledgebaseId"), "啊！這我不會回答，請稍等小編回復你～", 0.5)))
        {}
    }
}